...
const introText = {
  fr: "Salut ! Je m'appelle Florent (ou Flo pour que ce soit plus simple). C'est ma première fois au Portugal ! Tu trouveras ci-dessous la liste de ce que je recherche, et en swipant sur la droite, la liste de ce que je propose. Ce n'est pas exclusif je peux être intéressé par d'autres choses ! N'hésite donc pas à me proposer un trade 🙂",
  ...
  es: "¡Hola! Me llamo Florent (o Flo, para simplificar). ¡Es la primera vez que vengo a Portugal (solo hablo francés, inglés y un poco de español)! A continuación encontrarás la lista de lo que busco y, si deslizas hacia la derecha, la lista de lo que ofrezco. ¡No es una lista exclusiva, puede que me interesen otras cosas! Así que no dudes en proponerme un intercambio 🙂",
};
